...
const result = spawnSync(process.execPath, ["--check", path.join(root, "web-flasher/flasher.js")], { encoding: "utf8" });
if (result.status !== 0) throw new Error(result.stderr || "Flasher syntax check failed");
